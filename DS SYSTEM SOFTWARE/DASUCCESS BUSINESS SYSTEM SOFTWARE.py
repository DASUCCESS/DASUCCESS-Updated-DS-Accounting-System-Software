...
lblTitle=Label(Tops,font=('arial black',20,'bold'), width=60, text='DASUCCESS BUSINESS SYSTEM SOFTWARE',bd=17,bg='green',
...
Cal_F=Frame(ReceiptCal_F,bg='green',bd=6,relief=RIDGE)
Cal_F.pack(side=TOP)

Receipt_F=Frame(ReceiptCal_F,bg='green',bd=4,relief=RIDGE)
Receipt_F.pack(side=BOTTOM)

MenuFrame = Frame(root,bg='red',height= 5000,bd=10, relief=RIDGE)
MenuFrame.pack(side=LEFT)

Cost_F=Frame(MenuFrame,bg='green',bd=4)
Cost_F.pack(side=BOTTOM)
Drinks_F=Frame(MenuFrame,bg='green',bd=4)
Drinks_F.pack(side=TOP)


Drinks_F=Frame(MenuFrame,bg='green',bd=4,relief=RIDGE)
Drinks_F.pack(side=LEFT)
Food_F=Frame(MenuFrame,bg='green',bd=4,relief=RIDGE)
...
def iExit():
    iExit=tkinter.messagebox.askyesno("Exit DASUCCESS System","Confirm if you want to exit")
    if iExit > 0:
        root.destroy()
        return
...
def CostofItem():
    ...
    DrinksPrice = "Ngn",str('%.2f'%(PriceofDrinks))
    FoodPrice =  "Ngn",str('%.2f'%(PriceofFood))
    CostofFood.set(FoodPrice)
    CostofDrinks.set(DrinksPrice)
    SC = "Ngn",str('%.2f'%(1.59))
    ServiceCharge.set(SC)

    SubTotalofITEMS = "Ngn",str('%.2f'%(PriceofDrinks + PriceofFood + 1.59))
    SubTotal.set(SubTotalofITEMS)

    Tax = "Ngn",str('%.2f'%((PriceofDrinks + PriceofFood + 1.59) * 0.15))
    PaidTax.set(Tax)

    TT=((PriceofDrinks + PriceofFood + 1.59) * 0.15)
    TC="Ngn",str('%.2f'%(PriceofDrinks + PriceofFood + 1.59 + TT))
    TotalCost.set(TC)
...
###################### & Drinks ####################################################################
Fname=Label(Drinks_F,font=('arial',14,'bold'),text='Full Name:',bg='orange',bd=7,
                fg='black',)
Fname.grid(row=0,sticky=W)
Mname=Label(Drinks_F,font=('arial',14,'bold'),text='Middle Name:',bg='orange',bd=7,
                fg='black',)
Mname.grid(row=1,column=0,sticky=W)
Sname=Label(Drinks_F,font=('arial',14,'bold'),text='Surname:',bg='orange',bd=7,
                fg='black',)
...
txtDietCoke.grid(row=4,column=1)
